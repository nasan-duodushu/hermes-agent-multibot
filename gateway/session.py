...
class SessionSource:
    ...
    bot_instance_id: Optional[str] = None  # Bot identity inside a single-instance multi-bot runtime
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.bot_instance_id:
            d["bot_instance_id"] = self.bot_instance_id
        return d
...
def build_session_key(
    ...
    agent_prefix = f"agent:{source.bot_instance_id or 'main'}"
    if source.chat_type == "dm":
