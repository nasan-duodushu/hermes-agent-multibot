...
_SESSION_BOT_INSTANCE_ID: ContextVar = ContextVar("HERMES_SESSION_BOT_INSTANCE_ID", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_SESSION_BOT_INSTANCE_ID": _SESSION_BOT_INSTANCE_ID,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_BOT_INSTANCE_ID.set(bot_instance_id),
    ]
    return tokens
